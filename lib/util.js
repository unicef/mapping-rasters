 ...
 */
function process_line(line, count, direction_indexes, meta, lats, lons, admin, jstsPolygon, admin_to_pop) {
  return new Promise(function(resolve, reject) {
      ...
      var scores = line.split(/\s+/).slice(
        direction_indexes.w, // West
        direction_indexes.e  // East
      );
...
exports.get_direction_indexes = function (geojson, lats, lons) {
  ...
  direction_indexes.w = bs.closest(lons, direction_boundaries.w) - 1;
